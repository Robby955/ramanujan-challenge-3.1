...
\title{Ramanujan Challenge 2026, Problem 3.1:\\
the $7_2$ regulator integral is $4\pi^2/85$\\
\large A proposed computer-assisted proof and independent audit}
...
variety of the prime knot $7_2$.  We present a proposed computer-assisted proof
that
\[
 \int_{\alpha}^{\beta}
...
\section*{Nature of this proof}

This is a proposed \emph{computer-assisted} proof, and we want to be explicit about what
...
organizers on July 12, 2026; organizer review remains pending.  We therefore
make no claim of acceptance, priority, or being a ``first proof.''
...
Robert Sneiderman with extensive assistance from OpenAI Codex and other
